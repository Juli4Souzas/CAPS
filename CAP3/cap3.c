...
main(){
    ...
    do{
        ...
        printf("Digite o primeiro número: ", i+2);
        scanf("%d", &n1);
        int resSoma=n1, resSub=n1, resMult=n1;
        float resDiv=n1;

        do{
            printf("Digite o %d° número: ", i+2);
            scanf("%d", &n2);
            resSoma= soma(resSoma,n2);
            resSub= sub(resSub,n2);
            resMult= mult(resMult,n2);
            resDiv= div(resDiv,n2);
            i++;
        } while(i < j - 1);
