...
Sao eles:
   ...
   long     -> valores longos. Os valores sao guardados em 4 bytes de memoria
...
vimos anteriormente pode ser em 3 lugares. As classes de armazenamento trata
...
Alguns caracteres especiais foram criados em C para facilitar a portabilidade
